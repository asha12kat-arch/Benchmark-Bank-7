import svgPaths from "./svg-tndftukcoz";
...
function Frame6() {
  return (
    <div className="content-stretch flex flex-col gap-[2px] items-start relative shrink-0" data-name="Frame">
      ...
      <p className="font-['Geist:SemiBold',sans-serif] font-semibold relative shrink-0 text-[15px] text-white">••••••</p>
    </div>
  );
}
...
function TotalBalanceCard() {
  return (
    <div className="bg-[#0b1524] content-stretch flex flex-col gap-[16px] items-start p-[24px] relative rounded-[20px] shrink-0 w-full" data-name="total-balance-card">
      ...
      <Frame4 />
      <p className="[word-break:break-word] font-['Young_Serif:Regular',sans-serif] leading-[normal] not-italic relative shrink-0 text-[40px] text-white whitespace-nowrap">••••••••</p>
...
export default function DashboardBalanceHidden() {
  return (
    <div className="bg-gradient-to-b content-stretch flex flex-col from-[#0a1628] items-start relative size-full to-[#07111f]" data-name="dashboard-balance-hidden">

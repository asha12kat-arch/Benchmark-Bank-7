...
const TRANSACTIONS = [
  { id: "1", merchant: "Meta Bank", category: "Deposit", date: "2026", amount: 15000000, icon: "M" },
  { id: "2", merchant: "Opening Balance", category: "Deposit", date: "2026", amount: 13, icon: "O" },
  { id: "3", merchant: "Tracy A Vaughn", category: "Transfer Pending", date: "Sep. 10, 2026", amount: -40000, icon: "T" },
];
      ...
      <div className="flex flex-col flex-1 overflow-y-auto overflow-x-hidden w-full min-h-0">
        <div className="content-stretch flex flex-col gap-[20px] items-start p-[16px] relative w-full">
          ...
          <div className="content-stretch flex gap-[12px] items-start relative shrink-0 w-full">
            <div
              className="bg-[#0b1524] content-stretch flex flex-col gap-[6px] items-start p-[14px] relative rounded-[16px] flex-1 min-w-0"
              style={{
                boxShadow: "0px 10px 24px 0px rgba(0,0,0,0.15)",
            ...
            >
              ...
              <p className="font-['Young_Serif:Regular',sans-serif] leading-[normal] not-italic relative shrink-0 max-w-full whitespace-nowrap text-[clamp(8px,2.5vw,18px)] tracking-tight text-[#15803d]">
            ...
            >
              ...
              <p className="font-['Young_Serif:Regular',sans-serif] leading-[normal] not-italic relative shrink-0 max-w-full whitespace-nowrap text-[clamp(8px,2.5vw,18px)] tracking-tight text-[#f87171]">
          ...
          {/* Transaction List */}
          <div
            className="bg-[#0b1524] content-stretch flex flex-col items-start relative rounded-[20px] shrink-0 w-full overflow-hidden"
            style={{
          ...
          >
            {TRANSACTIONS.map((t, i) => (
              <div key={t.id} className="w-full min-w-0">
                <div className="content-stretch flex items-center gap-[12px] p-[14px] relative shrink-0 w-full min-w-0">
                  <div
                    className="bg-gradient-to-br from-[#1e293b] to-[#0f172a] flex items-center justify-center relative rounded-[14px] shrink-0 size-[44px]"
                    style={{ border: "1px solid rgba(255,255,255,0.08)" }}
                  >
                    <span className="font-['Geist:Bold',sans-serif] text-[14px] text-white">
                      {t.icon}
                    </span>
                  </div>

                  <div className="content-stretch flex flex-col gap-[3px] items-start relative flex-1 min-w-0">
                    <p className="font-['Geist:SemiBold',sans-serif] font-semibold relative shrink-0 text-[14px] text-white truncate max-w-full">
                      {t.merchant}
                    </p>
                  ...
                  <p
                    className={`font-['Geist:SemiBold',sans-serif] font-semibold relative shrink-0 w-[120px] min-w-0 text-right text-[11px] leading-[normal] ${
                      t.amount > 0 ? "text-[#15803d]" : "text-[#f87171]"
                    }`}
                  >
                    {t.amount > 0 ? "+" : ""}
                    {t.amount < 0 ? "-" : ""}$

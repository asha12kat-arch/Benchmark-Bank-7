      ...
      <div className="absolute right-[-120px] size-[320px] top-[-120px] pointer-events-none">
        <div className="absolute inset-[-34.38%]">
          <svg className="block size-full" fill="none" height="540" preserveAspectRatio="none" viewBox="0 0 540 540" width="540">
            <g filter="url(#hg1)" opacity="0.18">
              <circle cx="270" cy="270" fill="#8B1A2B" r="160" />
            </g>
            <defs>
              <filter colorInterpolationFilters="sRGB" filterUnits="userSpaceOnUse" height="540" id="hg1" width="540" x="0" y="0">
      ...
      <div className="absolute bottom-[-140px] left-[-80px] size-[260px] pointer-events-none">
        <div className="absolute inset-[-34.62%]">
          <svg className="block size-full" fill="none" height="440" preserveAspectRatio="none" viewBox="0 0 440 440" width="440">
            <g filter="url(#hg2)" opacity="0.06">
              <circle cx="220" cy="220" fill="white" r="130" />
            </g>
            <defs>
              <filter colorInterpolationFilters="sRGB" filterUnits="userSpaceOnUse" height="440" id="hg2" width="440" x="0" y="0">
                <feFlood floodOpacity="0" result="BackgroundImageFix" />
                <feBlend in="SourceGraphic" in2="BackgroundImageFix" mode="normal" result="shape" />
        ...
        <div className="content-stretch flex flex-col gap-[20px] items-start p-[16px] relative w-full">
          ...
          <div className="content-stretch flex items-center justify-between py-[12px] relative shrink-0 w-full">
            ...
            <button
              ...
              style={{ boxShadow: "0px 10px 12px rgba(0,0,0,0.15)" }}
            >
          ...
          {/* Balance Card */}
          <div
            className="bg-[#0b1524] content-stretch flex flex-col gap-[16px] items-start p-[24px] relative rounded-[20px] shrink-0 w-full"
            style={{
          ...
          >
            ...
            <div className="content-stretch flex items-center justify-between relative shrink-0 w-full">
              <p className="font-['Geist:SemiBold',sans-serif] font-semibold leading-[normal] relative shrink-0 text-[#94a3b8] text-[12px] uppercase">
                Total Balance
              </p>
          ...
          <div className="content-stretch flex gap-[12px] items-start relative shrink-0 w-full">
            ...
            <button
              ...
              className="bg-[rgba(255,255,255,0.04)] content-stretch flex flex-1 flex-col gap-[8px] items-center min-w-px p-[12px] relative rounded-[16px] border-0 cursor-pointer"
              style={{ boxShadow: "0px 10px 12px rgba(0,0,0,0.12)" }}
            >
              <div aria-hidden className="absolute border border-[rgba(255,255,255,0.08)] border-solid inset-0 pointer-events-none rounded-[16px]" />
          ...
          <button
            onClick={() => navigate("cards")}
            className="bg-gradient-to-r cursor-pointer from-[#0f172a] h-[200px] relative rounded-[20px] shrink-0 to-[#1e293b] w-full border-0 text-left"
          >
            <div className="content-stretch flex flex-col items-start justify-between overflow-clip p-[24px] relative rounded-[inherit] size-full">
              ...
              <div className="content-stretch flex items-center justify-between relative shrink-0 w-full">
                <div className="content-stretch flex gap-[8px] items-center relative shrink-0">
                  ...
                  <p className="font-['Young_Serif:Regular',sans-serif] leading-[normal] not-italic relative shrink-0 text-[14px] text-white">
                    Meta Bank
                  </p>
                </div>

                <p className="font-['Geist:Bold',sans-serif] font-bold leading-[normal] relative shrink-0 text-[11px] text-white">
                  DEBIT
                </p>
              </div>

              <p className="font-['Geist:SemiBold',sans-serif] font-semibold leading-[normal] relative shrink-0 text-[18px] text-white">
                •••• •••• •••• 7747
              </p>
            ...
            <div
              ...
              style={{
                boxShadow: "0px 10px 24px -10px rgba(139,26,43,0.12), 0px 18px 40px -12px rgba(0,0,0,0.2)",
              }}
            />
          </button>
